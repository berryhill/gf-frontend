    ...
    return (
      <div className='header'>
        ...
        <div className='social-profiles'>
          <a className='social-profile' href='https://www.facebook.com'>
            <img border="0"
          ...
          <a className='social-profile' href='https://www.twitter.com'>
            <img border='0'
          ...
          <a className='social-profile' href='https://www.google.com'>
            <img border='0'
